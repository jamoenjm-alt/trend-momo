...
REGIONS = {
    ...
    "NEWT": ("Newtown", "NSW", "postcode", "2042"),
    "MAR": ("Marrickville", "NSW", "postcode", "2204"),
    "RAN": ("Randwick", "NSW", "postcode", "2031"),
    "COOG": ("Coogee", "NSW", "postcode", "2034"),
    "MARO": ("Maroubra", "NSW", "postcode", "2035"),
    "KEN": ("Kensington (NSW)", "NSW", "postcode", "2033"),
    "ROC": ("Rockdale", "NSW", "postcode", "2216"),
    "KOG": ("Kogarah", "NSW", "postcode", "2217"),
    "MIR": ("Miranda", "NSW", "postcode", "2228"),
    "CAR": ("Caringbah", "NSW", "postcode", "2229"),
    "ENG": ("Engadine", "NSW", "postcode", "2233"),
    "MEN": ("Menai", "NSW", "postcode", "2234"),
    "PAD": ("Padstow", "NSW", "postcode", "2211"),
    "REV": ("Revesby", "NSW", "postcode", "2212"),
    "PAN": ("Panania", "NSW", "postcode", "2213"),
    "MER": ("Merrylands", "NSW", "postcode", "2160"),
    "GUI": ("Guildford (NSW)", "NSW", "postcode", "2161"),
    "GRA": ("Granville", "NSW", "postcode", "2142"),
    "AUB": ("Auburn", "NSW", "postcode", "2144"),
    "LID": ("Lidcombe", "NSW", "postcode", "2141"),
    "HOM": ("Homebush", "NSW", "postcode", "2140"),
    "STRA": ("Strathfield", "NSW", "postcode", "2135"),
    "BURW": ("Burwood", "NSW", "postcode", "2134"),
    "ASH": ("Ashfield", "NSW", "postcode", "2131"),
    "LEI": ("Leichhardt", "NSW", "postcode", "2040"),
    "BALM": ("Balmain", "NSW", "postcode", "2041"),
    "GLE": ("Glebe", "NSW", "postcode", "2037"),
    "SUR": ("Surry Hills", "NSW", "postcode", "2010"),
    "PADD": ("Paddington (NSW)", "NSW", "postcode", "2021"),
    "DOU": ("Double Bay", "NSW", "postcode", "2028"),
    "ROS": ("Rose Bay", "NSW", "postcode", "2029"),
    "VAU": ("Vaucluse", "NSW", "postcode", "2030"),
    "MOS": ("Mosman", "NSW", "postcode", "2088"),
    "NEU": ("Neutral Bay", "NSW", "postcode", "2089"),
    "CRE": ("Cremorne", "NSW", "postcode", "2090"),
    "CRO": ("Crows Nest", "NSW", "postcode", "2065"),
    "NOR": ("North Sydney", "NSW", "postcode", "2060"),
    "LAN": ("Lane Cove", "NSW", "postcode", "2066"),
    "WIL": ("Willoughby", "NSW", "postcode", "2068"),
    "ART": ("Artarmon", "NSW", "postcode", "2064"),
    "ROSE": ("Roseville", "NSW", "postcode", "2069"),
    "KIL": ("Killara", "NSW", "postcode", "2071"),
    "STI": ("St Ives", "NSW", "postcode", "2075"),
    "TUR": ("Turramurra", "NSW", "postcode", "2074"),
    "WAH": ("Wahroonga", "NSW", "postcode", "2076"),
    "EPPI": ("Epping (NSW)", "NSW", "postcode", "2121"),
    "EAS": ("Eastwood", "NSW", "postcode", "2122"),
    "CARL": ("Carlingford", "NSW", "postcode", "2118"),
    "BAU": ("Baulkham Hills", "NSW", "postcode", "2153"),
    "SEV": ("Seven Hills", "NSW", "postcode", "2147"),
    "TOO": ("Toongabbie", "NSW", "postcode", "2146"),
    "WEN": ("Wentworthville", "NSW", "postcode", "2145"),
    "QUA": ("Quakers Hill", "NSW", "postcode", "2763"),
    "STM": ("St Marys", "NSW", "postcode", "2760"),
    "MOU": ("Mount Druitt", "NSW", "postcode", "2770"),
    "KIN": ("Kingswood", "NSW", "postcode", "2747"),
    "GLEN": ("Glenmore Park", "NSW", "postcode", "2745"),
    "WIN": ("Windsor", "NSW", "postcode", "2756"),
    "BOW": ("Bowraville", "NSW", "postcode", "2449"),
    "KEM": ("Kempsey", "NSW", "postcode", "2440"),
    "NAM": ("Nambucca Heads", "NSW", "postcode", "2448"),
    "SAW": ("Sawtell", "NSW", "postcode", "2452"),
    "CAS": ("Casino", "NSW", "postcode", "2470"),
    "KYO": ("Kyogle", "NSW", "postcode", "2474"),
    "MUR": ("Murwillumbah", "NSW", "postcode", "2484"),
    "SCO": ("Scone", "NSW", "postcode", "2337"),
    "GLO": ("Gloucester", "NSW", "postcode", "2422"),
    "BUL": ("Bulahdelah", "NSW", "postcode", "2423"),
    ...
    "RIC": ("Richmond (VIC)", "VIC", "postcode", "3121"),
    "FIT": ("Fitzroy", "VIC", "postcode", "3065"),
    "CARLT": ("Carlton", "VIC", "postcode", "3053"),
    "BRU": ("Brunswick", "VIC", "postcode", "3056"),
    "COB": ("Coburg", "VIC", "postcode", "3058"),
    "NORT": ("Northcote", "VIC", "postcode", "3070"),
    "THO": ("Thornbury", "VIC", "postcode", "3071"),
    "RES": ("Reservoir", "VIC", "postcode", "3073"),
    "ESS": ("Essendon", "VIC", "postcode", "3040"),
    "MOO": ("Moonee Ponds", "VIC", "postcode", "3039"),
    "ASC": ("Ascot Vale", "VIC", "postcode", "3032"),
    "KENS": ("Kensington (VIC)", "VIC", "postcode", "3031"),
    "YAR": ("Yarraville", "VIC", "postcode", "3013"),
    "ALT": ("Altona", "VIC", "postcode", "3018"),
    "WILL": ("Williamstown", "VIC", "postcode", "3016"),
    "NEWP": ("Newport", "VIC", "postcode", "3015"),
    "HAM": ("Hampton", "VIC", "postcode", "3188"),
    "SAN": ("Sandringham", "VIC", "postcode", "3191"),
    "MENT": ("Mentone", "VIC", "postcode", "3194"),
    "MORD": ("Mordialloc", "VIC", "postcode", "3195"),
    "CHE": ("Cheltenham", "VIC", "postcode", "3192"),
    "BENT": ("Bentleigh", "VIC", "postcode", "3204"),
    "OAK": ("Oakleigh", "VIC", "postcode", "3166"),
    "MAL": ("Malvern", "VIC", "postcode", "3144"),
    "PRAH": ("Prahran", "VIC", "postcode", "3181"),
    "SOU": ("South Yarra", "VIC", "postcode", "3141"),
    "HAW": ("Hawthorn", "VIC", "postcode", "3122"),
    "KEW": ("Kew", "VIC", "postcode", "3101"),
    "BALW": ("Balwyn", "VIC", "postcode", "3103"),
    "BLA": ("Blackburn", "VIC", "postcode", "3130"),
    "MIT": ("Mitcham", "VIC", "postcode", "3132"),
    "VER": ("Vermont", "VIC", "postcode", "3133"),
    "WAN": ("Wantirna", "VIC", "postcode", "3152"),
    "FER": ("Ferntree Gully", "VIC", "postcode", "3156"),
    "BEL": ("Belgrave", "VIC", "postcode", "3160"),
    "LIL": ("Lilydale", "VIC", "postcode", "3140"),
    "HEA": ("Healesville", "VIC", "postcode", "3777"),
    "YARR": ("Yarra Glen", "VIC", "postcode", "3775"),
    "SUNB": ("Sunbury North", "VIC", "postcode", "3428"),
    "DIG": ("Diggers Rest", "VIC", "postcode", "3427"),
    "WAL": ("Wallan", "VIC", "postcode", "3756"),
    "KILM": ("Kilmore", "VIC", "postcode", "3764"),
    "BRO": ("Broadford", "VIC", "postcode", "3658"),
    "EUR": ("Euroa", "VIC", "postcode", "3666"),
    "MAN": ("Mansfield", "VIC", "postcode", "3722"),
    "BRIG": ("Bright", "VIC", "postcode", "3741"),
    "BEE": ("Beechworth", "VIC", "postcode", "3747"),
    "RUT": ("Rutherglen", "VIC", "postcode", "3685"),
    "NUM": ("Numurkah", "VIC", "postcode", "3636"),
    "COBR": ("Cobram", "VIC", "postcode", "3644"),
    "KYA": ("Kyabram", "VIC", "postcode", "3620"),
    "ROCH": ("Rochester", "VIC", "postcode", "3561"),
    "MARY": ("Maryborough (VIC)", "VIC", "postcode", "3465"),
    "STAW": ("Stawell", "VIC", "postcode", "3380"),
    "DAY": ("Daylesford", "VIC", "postcode", "3460"),
    ...
    "NEWF": ("New Farm", "QLD", "postcode", "4005"),
    "PADDI": ("Paddington (QLD)", "QLD", "postcode", "4064"),
    "TOOW": ("Toowong", "QLD", "postcode", "4066"),
    "ASHG": ("Ashgrove", "QLD", "postcode", "4060"),
    "CLA": ("Clayfield", "QLD", "postcode", "4011"),
    "HAMI": ("Hamilton (QLD)", "QLD", "postcode", "4007"),
    "NUN": ("Nundah", "QLD", "postcode", "4012"),
    "MITC": ("Mitchelton", "QLD", "postcode", "4053"),
    "FERN": ("Ferny Hills", "QLD", "postcode", "4055"),
    "BRA": ("Bracken Ridge", "QLD", "postcode", "4017"),
    "WYN": ("Wynnum", "QLD", "postcode", "4178"),
    "MANL": ("Manly (QLD)", "QLD", "postcode", "4179"),
    "CAP": ("Capalaba", "QLD", "postcode", "4157"),
    "VIC": ("Victoria Point", "QLD", "postcode", "4165"),
    "MOUN": ("Mount Gravatt", "QLD", "postcode", "4122"),
    "HOL": ("Holland Park", "QLD", "postcode", "4121"),
    "COOR": ("Coorparoo", "QLD", "postcode", "4151"),
    "ANN": ("Annerley", "QLD", "postcode", "4103"),
    "MOOR": ("Moorooka", "QLD", "postcode", "4105"),
    "ACA": ("Acacia Ridge", "QLD", "postcode", "4110"),
    "FORE": ("Forest Lake", "QLD", "postcode", "4078"),
    "INA": ("Inala", "QLD", "postcode", "4077"),
    "BOO": ("Booval", "QLD", "postcode", "4304"),
    "RIP": ("Ripley", "QLD", "postcode", "4306"),
    "ROSEW": ("Rosewood", "QLD", "postcode", "4340"),
    "LOW": ("Lowood", "QLD", "postcode", "4311"),
    "BEA": ("Beaudesert", "QLD", "postcode", "4285"),
    "CAN": ("Canungra", "QLD", "postcode", "4275"),
    "TAM": ("Tamborine", "QLD", "postcode", "4272"),
    "CUR": ("Currumbin", "QLD", "postcode", "4223"),
    "MUD": ("Mudgeeraba", "QLD", "postcode", "4213"),
    "SOUT": ("Southport North", "QLD", "postcode", "4216"),
    "COOL": ("Coolum Beach", "QLD", "postcode", "4573"),
    "KAW": ("Kawana Waters", "QLD", "postcode", "4575"),
    "BEER": ("Beerwah", "QLD", "postcode", "4519"),
    "LAND": ("Landsborough", "QLD", "postcode", "4550"),
    "YAN": ("Yandina", "QLD", "postcode", "4561"),
    "COORO": ("Cooroy", "QLD", "postcode", "4563"),
    "TEW": ("Tewantin", "QLD", "postcode", "4565"),
    "CHI": ("Childers", "QLD", "postcode", "4660"),
    "AGN": ("Agnes Water", "QLD", "postcode", "4677"),
    "BIL": ("Biloela", "QLD", "postcode", "4715"),
    "MORA": ("Moranbah", "QLD", "postcode", "4744"),
    "PRO": ("Proserpine", "QLD", "postcode", "4800"),
    "ING": ("Ingham", "QLD", "postcode", "4850"),
    "TUL": ("Tully", "QLD", "postcode", "4854"),
    ...
    "SUB": ("Subiaco", "WA", "postcode", "6008"),
    "CLAR": ("Claremont", "WA", "postcode", "6010"),
    "COT": ("Cottesloe", "WA", "postcode", "6011"),
    "NED": ("Nedlands", "WA", "postcode", "6009"),
    "MOUNT": ("Mount Lawley", "WA", "postcode", "6050"),
    "INGL": ("Inglewood", "WA", "postcode", "6052"),
    "VICT": ("Victoria Park", "WA", "postcode", "6100"),
    "SOUTH": ("South Perth", "WA", "postcode", "6151"),
    "APP": ("Applecross", "WA", "postcode", "6153"),
    "BOOR": ("Booragoon", "WA", "postcode", "6154"),
    "BULL": ("Bull Creek", "WA", "postcode", "6149"),
    "BIB": ("Bibra Lake", "WA", "postcode", "6163"),
    "KWI": ("Kwinana", "WA", "postcode", "6167"),
    "WEL": ("Wellard", "WA", "postcode", "6170"),
    "BENTL": ("Bentley", "WA", "postcode", "6102"),
    "CANN": ("Cannington", "WA", "postcode", "6107"),
    "MAD": ("Maddington", "WA", "postcode", "6109"),
    "KEL": ("Kelmscott", "WA", "postcode", "6111"),
    "MUN": ("Mundijong", "WA", "postcode", "6123"),
    "GIR": ("Girrawheen", "WA", "postcode", "6064"),
    "BALL": ("Ballajura", "WA", "postcode", "6066"),
    "PADB": ("Padbury", "WA", "postcode", "6025"),
    "SORR": ("Sorrento (WA)", "WA", "postcode", "6020"),
    "KAR": ("Karrinyup", "WA", "postcode", "6018"),
    "OSB": ("Osborne Park", "WA", "postcode", "6017"),
    "WEM": ("Wembley", "WA", "postcode", "6014"),
    "CAPE": ("Capel", "WA", "postcode", "6271"),
    "BOY": ("Boyup Brook", "WA", "postcode", "6244"),
    ...
    "NORTH": ("North Adelaide", "SA", "postcode", "5006"),
    "WALK": ("Walkerville", "SA", "postcode", "5081"),
    "PAY": ("Payneham", "SA", "postcode", "5070"),
    "MAG": ("Magill", "SA", "postcode", "5072"),
    "BURN": ("Burnside", "SA", "postcode", "5066"),
    "GLENO": ("Glen Osmond", "SA", "postcode", "5064"),
    "COLO": ("Colonel Light Gardens", "SA", "postcode", "5041"),
    "EDW": ("Edwardstown", "SA", "postcode", "5039"),
    "SEAC": ("Seacombe Gardens", "SA", "postcode", "5047"),
    "BRIGH": ("Brighton (SA)", "SA", "postcode", "5048"),
    "SOM": ("Somerton Park", "SA", "postcode", "5044"),
    "WOO": ("Woodville Park", "SA", "postcode", "5011"),
    "CROY": ("Croydon (SA)", "SA", "postcode", "5008"),
    "ENF": ("Enfield", "SA", "postcode", "5085"),
    "PAR": ("Parafield Gardens", "SA", "postcode", "5107"),
    "SMI": ("Smithfield (SA)", "SA", "postcode", "5114"),
    "VIR": ("Virginia (SA)", "SA", "postcode", "5120"),
    "GUM": ("Gumeraccha", "SA", "postcode", "5233"),
    "LIT": ("Littlehampton", "SA", "postcode", "5250"),
    "WILLU": ("Willunga", "SA", "postcode", "5172"),
    "YANK": ("Yankalilla", "SA", "postcode", "5203"),
    "MENI": ("Meningie", "SA", "postcode", "5264"),
    "BORD": ("Bordertown", "SA", "postcode", "5268"),
    "KIM": ("Kimba", "SA", "postcode", "5641"),
    ...
    "YOU": ("Youngtown", "TAS", "postcode", "7249"),
    "OLD": ("Old Beach", "TAS", "postcode", "7017"),
    "KET": ("Kettering", "TAS", "postcode", "7155"),
    "FRA": ("Franklin", "TAS", "postcode", "7113"),
    "POR": ("Port Sorell", "TAS", "postcode", "7307"),
    # ACT / NT
